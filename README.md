...
kuboon氏の手直しを受けていたほうがmainブランチであることを忘れて、古いファイルをアップロードしていたことに気づかなかったのを直しました。
...
これは既約であることを条件に、あらゆるエラーパターンを訂正できるという原理の利用したもので、ランダム多項式を使った場合
およそ一分間プログラムが止まらなければ、その多項式は既約である可能性が高いことがsageを使った検証結果で分かっています。
この場合、las vegasアルゴリズムである可能性が高く、この確率的検査が既約性の必要条件を満たしているものと考えられます。
